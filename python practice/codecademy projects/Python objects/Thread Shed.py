...
#split individual transaction into data points
...
transactions_clean = []
for row in daily_transactions_split: #iterates over the values of daily_transactions_split list
  for col in range(len(row)): #iterates over the index of row
    row[col] = row[col].strip()
  transactions_clean.append(row)
#print(transactions_clean)

#collect individual data points for individual transactions
customers =[]
sales =[]
thread_sold =[]
for clean_data in transactions_clean:
  customers.append(clean_data[0])
  sales.append(clean_data[1])
  thread_sold.append(clean_data[2])
#print(customers)
#print(sales)
#print(thread_sold)

#count how much has been made
total_sales = 0
for sale in sales:
  sale = sale.strip('$')
  sale = float(sale)
...
#separate multiple colors and add them individually to a list
thread_sold_split =[]
...
#or we don't have to iterate through thread_sold_split:
#def color_count(color):
  #color_count = thread_sold_split.count(color)
  #return color_count
#print(color_count('white'))
